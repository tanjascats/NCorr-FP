...
class NCorrFP():
    ...
    def insertion(self, dataset_name, recipient_id, secret_key, primary_key_name=None, outfile=None,
        ...
        self.balltree = init_balltrees(correlated_attributes, relation.drop('Id', axis=1), self.dist_metric_discrete,
    ...
    for data_size in data_sizes:
        for k in ks:
            ...
            for _ in range(n_exp):
                ...
                original_path = "NCorrFP/test/test_data/synthetic_{}_3_continuous.csv".format(data_size)
